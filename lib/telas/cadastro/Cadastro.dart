...
class _CadastroState extends State<Cadastro> {
  ...
  _validarCampos() {
    ...
    if (int.parse(idade) <= 14 && _tipoUsuario == true) {
      if (int.parse(idade) >= 18 && _tipoUsuario == false) {
        ...
        setState(() {
          _mensagemErro = "O usuário não pode ser um responsável";
        });
      }
    } else {
      setState(() {
        _mensagemErro = "O usuário não pode ser um tutorado";
      });
    }
  }
  ...
  _cadastrarUsuario(Usuario usuario) {
    ...
    auth
      ...
      _mensagemErro =
          "Erro ao cadastrar o usuario, Verifique e tente novamente";
    });
  }
